...
export declare class Transaction implements firestore.Transaction {
    ...
    update(documentRef: firestore.DocumentReference, field: string | ExternalFieldPath, value: unknown, ...moreFieldsAndValues: Array<unknown>): Transaction;
...
export declare class WriteBatch implements firestore.WriteBatch {
    ...
    update(documentRef: firestore.DocumentReference, field: string | ExternalFieldPath, value: unknown, ...moreFieldsAndValues: Array<unknown>): WriteBatch;
...
export declare class DocumentReference implements firestore.DocumentReference {
    ...
    update(field: string | ExternalFieldPath, value: unknown, ...moreFieldsAndValues: Array<unknown>): Promise<void>;
    delete(): Promise<void>;
...
export declare class Query implements firestore.Query {
    ...
    startAt(docOrField: unknown | firestore.DocumentSnapshot, ...fields: Array<unknown>): firestore.Query;
    startAfter(docOrField: unknown | firestore.DocumentSnapshot, ...fields: Array<unknown>): firestore.Query;
    endBefore(docOrField: unknown | firestore.DocumentSnapshot, ...fields: Array<unknown>): firestore.Query;
    endAt(docOrField: unknown | firestore.DocumentSnapshot, ...fields: Array<unknown>): firestore.Query;
