...
export declare function filter(path: string, op: string, value: unknown): Filter;
...
export declare function expectEqualArrays(left: Array<unknown>, right: Array<unknown>, message?: string): void;
/**
